...
uint8_t X[50] __SECTION_ZERO("free_area");
// uint8_t X[50];                    // Using Mainly in Send function to store datas
uint8_t encX1[16];      // Split and send AES Encrypted data
uint8_t encX2[16];      // Split and send AES Encrypted data
uint8_t val_1[16];      // Split and store AES Decrypted data
uint8_t val_2[16];      // Split and store AES Decrypted data
