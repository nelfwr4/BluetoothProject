...
/****************************************************************************************/
#if defined (__DA14531__)
		#define GPIO_M1_PORT           GPIO_PORT_0
    #define GPIO_M1_PIN            GPIO_PIN_9
		
		#define GPIO_M2_PORT           GPIO_PORT_0
    #define GPIO_M2_PIN            GPIO_PIN_8
//		
    #define GPIO_HANDLE_PORT           GPIO_PORT_0
    #define GPIO_HANDLE_PIN            GPIO_PIN_5//6
//		
		#define GPIO_BOLT_PORT           GPIO_PORT_0
    #define GPIO_BOLT_PIN            GPIO_PIN_11
		
		#define GPIO_EN_PORT           GPIO_PORT_0
    #define GPIO_EN           GPIO_PIN_6
